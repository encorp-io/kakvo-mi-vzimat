    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'За да изчислите нетната си заплата за 2026, въведете брутната си заплата в калкулатора. Автоматично ще бъдат изчислени всички данъци и осигуровки според актуалните ставки за 2026: пенсионни осигуровки (6.58%), здравни осигуровки (3.2%), ОЗМ (1.4%), безработица (0.4%), ДЗПО (2.2%) и подоходен данък (10%).'
        }
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'През 2026 година има една основна промяна: максималният осигурителен доход се увеличава от 2,111.46 EUR на 2,300 EUR. Всички осигурителни ставки и подоходният данък от 10% остават непроменени спрямо 2025 година. Промяната засяга само хората с брутна заплата над 2,111.46 EUR.'
        }
      },
      {
        '@type': 'Question',
        ...
        <div className="mt-16 max-w-4xl mx-auto bg-gradient-to-br from-zinc-900 to-black border border-zinc-800 rounded-2xl p-8">
          ...
          <div className="space-y-4 text-zinc-300">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-semibold text-white">Осигурителни ставки</p>
                <p className="text-sm text-zinc-400">
                  Остават непроменени: пенсии <span className="text-white font-mono">6.58%</span> за служителя и{' '}
                  <span className="text-white font-mono">8.22%</span> за работодателя, ОЗМ 1.4%, безработица 0.4%,
                  ДЗПО 2.2% и здравно осигуряване 3.2%
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              <span className="text-green-500 font-bold text-xl shrink-0">=</span>
              <div>
                <p className="font-semibold text-white">Данък върху доходите на физическите лица</p>
                <p className="text-sm text-zinc-400">
                  Остава <span className="text-white font-mono">10%</span> без промяна
                </p>
              </div>
            </div>
            ...
            <div className="mt-6 p-4 bg-danger-950/30 border border-danger-500/30 rounded-lg">
              <p className="text-sm text-danger-300">
                <strong>Важно:</strong> Промяната засяга само хората с брутна заплата над
                2,111.46 EUR. Ако брутната ви заплата е под стария максимален осигурителен доход,
                нетната ви заплата остава същата. Най-засегнати са хората с брутна заплата
                над 2,300 EUR.
              </p>
            </div>
          </div>
        ...
        <div className="mt-16 max-w-4xl mx-auto bg-zinc-950/50 border border-zinc-800 rounded-2xl p-8">
          ...
          <div className="space-y-4 text-zinc-300 leading-relaxed">
            ...
            <p>
              ...
              за 2026 година и автоматично изчислява всички задължителни осигуровки: пенсионни осигуровки (6.58%),
          ...
          <div className="space-y-4">
            ...
            <details className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-6 group">
              ...
              <p className="mt-4 text-zinc-400 leading-relaxed">
                ...
                пенсионни осигуровки (6.58%), здравни осигуровки (3.2%), ОЗМ (1.4%), безработица (0.4%),
            ...
            <details className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-6 group">
              ...
              <p className="mt-4 text-zinc-400 leading-relaxed">
                През 2026 година има една основна промяна: максималният осигурителен доход се увеличава от
                2,111.46 EUR на 2,300 EUR. Всички осигурителни ставки и подоходният данък от 10% остават
                непроменени спрямо 2025 година. Промяната води до по-малка нетна заплата само за хората
                с брутна заплата над 2,111.46 EUR.
              </p>
            </details>
            ...
            <details className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-6 group">
              ...
              <p className="mt-4 text-zinc-400 leading-relaxed">
                От заплатата в България се удържат следните осигуровки: пенсионни осигуровки (6.58% за 2026),
            ...
            <details className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-6 group">
              ...
              <p className="mt-4 text-zinc-400 leading-relaxed">
                Нетната заплата през 2026 е по-ниска заради повишаването на максималния осигурителен доход до
                2,300 EUR. Осигуровки се дължат върху по-голяма част от брутната заплата, което води до по-малка
                чиста заплата. Ако брутната ви заплата е под 2,111.46 EUR, нетната ви заплата не се променя.
              </p>
            </details>
          </div>
        </div>
